...
OnlineMonConfiguration::OnlineMonConfiguration() { SetDefaults(); }
...
string OnlineMonConfiguration::getSnapShotDir() const { return SnapShotDir; }

void OnlineMonConfiguration::setConfigurationFileName(
    string ConfigurationFileName) {
  this->ConfigurationFileName = ConfigurationFileName;
}

void OnlineMonConfiguration::setMimosa26_max_sections(
...
double OnlineMonConfiguration::getHotpixelcut() const { return hotpixelcut; }
...
void OnlineMonConfiguration::setMimosa26_section_boundary(
...
void OnlineMonConfiguration::setCorrel_minclustersize(
...
void OnlineMonConfiguration::PrintConfiguration() {
  cout << "OnlineMon Configuration" << endl
       << endl;
...
void OnlineMonConfiguration::setPlanes_to_be_skipped(
...
unsigned int OnlineMonConfiguration::stringsplit(string str, char c,
                                                 vector<string> &v) {
  size_t startpos = 0;
  size_t endpos = 0;
