...
#xterm -r -sb -sl 100000 -geometry 80x4 -T "DC1" -e "./bin/euCliCollector -n AlpideDataCollector -t dc1 -r tcp://$HOSTIP:$RCPORT | tee -a data/logs/dc1_${currentdate}.log; read" &
#not yet written: 
#xterm -r -sb -sl 100000 -geometry 80x4 -T "Total 5 Collector 1" -e "./bin/euCliCollector -n AhcalBifTluAlpieTableDataCollector -t dcall1 -r tcp://$HOSTIP:$RCPORT | tee -a data/logs/dcall1_${currentdate}.log; read" &
#xterm -r -sb -sl 100000 -geometry 160x24 -T "BXID col" -e "./bin/euCliCollector -n CaliceAhcalBifBxidDataCollector -t bxidColl1 | tee -a data/logs/dcbxid1_${currentdate}.log ; read" &
xterm -sb -sl 100000 -geometry 80x4 -T "DS DC2" -e "./bin/euCliCollector -n DirectSaveDataCollector -t dc2 -r tcp://$HOSTIP:$RCPORT | tee -a data/logs/dc2_${currentdate}.log; read" &
#xterm -r -sb -sl 100000 -geometry 80x4 -T "DC3" -e "./bin/euCliCollector -n TriggerIDSyncDataCollector -t dc3 -r tcp://$HOSTIP:$RCPORT | tee -a data/logs/dc3_${currentdate}.log; read" &
...
# sleep 1
xterm -sb -sl 100000 -geometry 160x30 -T "AHCAL" -e './bin/euCliProducer -n AHCALProducer -t AHCAL1 -r tcp://$HOSTIP:$RCPORT |tee -a data/logs/ahcal_${currentdate}.log ; read'&
...
#xterm -r -sb -sl 100000 -geometry 160x24 -T "TLU" -e "./bin/euCliProducer -n AidaTluProducer -t aida_tlu -r tcp://$HOSTIP:$RCPORT |tee -a data/logs/tlu_${currentdate}.log ; read"&
#xterm -r -sb -sl 100000 -geometry 160x24 -T "ALPIDE" -e "./bin/euCliProducer -n AltelProducer -t altel -r tcp://$HOSTIP:$RCPORT |tee -a data/logs/alpide_${currentdate}.log ; read"&
