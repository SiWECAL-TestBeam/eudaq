...
namespace eudaq {
   ...
   class CaliceCommonRawEvent2LCEventConverter: public LCEventConverter {
      public:
         bool Converting(EventSPC d1, LCEventSP d2, ConfigurationSPC conf) const override;
         static const uint32_t m_id_factory = cstr2hash("CaliceCommonObject");
      private:
   ...
   namespace {
      auto dummy0 = Factory<LCEventConverter>::Register<CaliceCommonRawEvent2LCEventConverter>(CaliceCommonRawEvent2LCEventConverter::m_id_factory);
   }
   ...
   bool CaliceCommonRawEvent2LCEventConverter::Converting(EventSPC d1, LCEventSP d2, ConfigurationSPC conf) const {
...
//            std::cout << "DEBUG shiftedUnixTS=" << shiftedUnixTS << std::endl;
   ...
   LCCollectionVec* CaliceCommonRawEvent2LCEventConverter::createCollectionVec(lcio::LCEvent &result, string colName, string dataDesc, time_t timestamp,
   ...
   void CaliceCommonRawEvent2LCEventConverter::getScCALHVSubEvent(const std::vector<uint8_t>& bl, LCCollectionVec *col) const {
   ...
   void CaliceCommonRawEvent2LCEventConverter::getDataLCIOGenericObject(const std::vector<uint8_t> & bl, LCCollectionVec *col, int nblock) const {
   ...
   void CaliceCommonRawEvent2LCEventConverter::getDataLCIOGenericObject(eudaq::RawDataEvent const * rawev, LCCollectionVec *col, int nblock, int nblock_max) const {
