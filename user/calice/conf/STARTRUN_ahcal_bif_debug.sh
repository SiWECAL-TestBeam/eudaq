...
#################  Data collector #################
xterm -r -sb -sl 100000 -T "Collector 1" -e 'bin/euCliCollector -n DirectSaveDataCollector -t dc1 ; read' &
xterm -r -sb -sl 100000 -T "Collector 3" -e 'bin/euCliCollector -n DirectSaveDataCollector -t dc3 ; read' &
...
#################  Producer #################
#xterm -sb -sl 1000000 -geometry 160x30 -T "Hodoscope 1" -e 'bin/euCliProducer -n CaliceEasirocProducer -t hodoscope1 |tee -a data/logs/hodoscope1.log ; read'&
#xterm -sb -sl 1000000 -geometry 160x30 -T "Hodoscope 2" -e 'bin/euCliProducer -n CaliceEasirocProducer -t hodoscope2 |tee -a data/logs/hodoscope2.log ; read'&
# sleep 1
